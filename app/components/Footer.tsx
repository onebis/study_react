...
export function Footer() {
  return (
    <div className='mb-33 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left'>
      {ITEMS.map((item) => {
        return (
          <a
            href={item.href}
          ...
          >
            ...
            <p className={`m-1 max-w-[30ch] text-sm opacity-50`}>{item.description}</p>
          </a>
        )
      })}
    </div>
